$(document).ready(function (e) {
    ...
    window.addEventListener('scroll', function () {
        ...
        if (scrollTop > lastScrollTop && !$('.header-main-nav').hasClass('is-active')) {
            $('.header-main .header-main-nav').addClass('hidden-nav-main');
            $('.header-main .header-main-nav').slideUp(200);
        } else {
            $('.header-main .header-main-nav').removeClass('hidden-nav-main');
            $('.header-main .header-main-nav').slideDown(200);
        }
